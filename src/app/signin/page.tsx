      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6 text-center">Sign in to continue your learning journey</p>
            ...
            <p className="text-center text-gray-600 mt-6">
              ...
              <Link href="/enroll" className="text-orange-500 hover:text-orange-600 font-semibold">
                Sign Up
              </Link>
            </p>
          </div>
